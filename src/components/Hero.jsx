...
export default function Hero({ onOpenQuote }) {
  ...
  return (
    <section className="relative pt-24 sm:pt-32 pb-16 sm:pb-20 bg-[#060b1c] text-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mb-12 sm:mb-16 pt-2 sm:pt-4">
          ...
          <div className="flex flex-wrap items-center gap-2.5 sm:gap-3 mb-5 sm:mb-6">
            ...
            <span className="font-heading text-[10px] sm:text-xs lg:text-sm font-extrabold text-cyan-300 tracking-wider uppercase py-1 drop-shadow-md">
              Structured Cabling & Infrastructure Specialists
            </span>
          </div>

          {/* Looping BlurText Main Headline */}
          <div className="mb-4 sm:mb-6 min-h-[130px] sm:min-h-[170px] lg:min-h-[210px] flex items-center overflow-hidden">
          ...
          {/* Subhead Lead */}
          <p className="text-slate-200 text-sm sm:text-lg lg:text-xl font-medium leading-relaxed mb-6 sm:mb-8 max-w-2xl drop-shadow">
            Structured cabling, networking, CCTV, security and AV infrastructure — designed, terminated, tested and supported by a <strong className="text-cyan-300 font-bold">40+ person in-house team</strong> with <strong className="text-white font-extrabold">12+ years</strong> on live enterprise sites across India.
          </p>

          {/* GET A QUOTE Button — Completely Solid Blue */}
          <div>
            <button
              onClick={onOpenQuote}
              className="w-full sm:w-auto px-7 sm:px-8 py-3.5 sm:py-4.5 rounded-xl font-sans text-xs sm:text-sm font-bold bg-[#2563eb] hover:bg-[#1d4ed8] text-white shadow-[0_0_25px_rgba(37,99,235,0.5)] hover:shadow-blue-500/70 hover:scale-105 transition-all flex items-center justify-center gap-2.5 cursor-pointer active:scale-95"
            >
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-3 sm:gap-4 pt-6 sm:pt-8 border-t border-white/20">
          {stats.map((stat, i) => (
            <motion.div
              key={stat.label}
              initial={{ opacity: 0, y: 15 }}
              ...
              className="bg-white/95 backdrop-blur-md p-3.5 sm:p-5 rounded-2xl border border-white/50 shadow-2xl flex flex-col items-start justify-center relative overflow-hidden group hover:border-cyan-400 transition-colors"
            >
              <div className="font-heading font-black text-2xl sm:text-3xl lg:text-4xl text-slate-900 tracking-tight flex items-center">
                ...
                <CountUp
                  ...
                  to={stat.to}
                  duration={1.5}
                  className="font-heading font-black text-slate-900"
                />
