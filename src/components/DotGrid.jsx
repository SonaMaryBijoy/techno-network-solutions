...
const DotGrid = ({
    ...
    const onMove = e => {
      ...
      for (const dot of dotsRef.current) {
        ...
        if (speed > speedTrigger && dist < proximity && !dot._inertiaApplied) {
          ...
          const pushX = (dot.cx - pr.x + vx * 0.005) * 0.4;
          const pushY = (dot.cy - pr.y + vy * 0.005) * 0.4;
  ...
  return (
    <div className={`pointer-events-none absolute inset-0 overflow-hidden w-full h-full ${className}`} style={style}>
