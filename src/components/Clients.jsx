...
export default function Clients() {
  ...
  return (
    <section id="clients" className="py-12 sm:py-16 bg-transparent border-y border-slate-200/80 overflow-hidden relative text-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        
        {/* Clean Header Section Without Glassmorphic Container Box */}
        <AnimatedContent distance={40} direction="vertical" duration={0.8} ease="power3.out">
          <div ref={containerRef} className="w-full mb-6 sm:mb-10 text-center max-w-5xl mx-auto">
            <h2 className="text-2xl sm:text-4xl lg:text-5xl font-display font-black text-slate-950 uppercase tracking-tight leading-tight mb-2 sm:mb-3">
              <span>CERTIFIED BY GLOBAL LEADERS IN </span>
              <span className="text-[#2563eb]">CABLING & SECURITY.</span>
            </h2>
            <p className="text-slate-700 text-sm sm:text-base lg:text-lg font-medium leading-relaxed max-w-3xl mx-auto">
