  ...
  return (
    <Html center>
      {placeholderSrc ? (
        ...
        <span className="font-mono text-xs text-[#12ACE0] font-bold bg-white/90 px-2 py-1 rounded shadow-xs">{Math.round(progress)} %</span>
      )}
    </Html>
  );
};
  ...
  return (
    ...
    >
      {showScreenshotButton && (
        <button
          onClick={capture}
          className="absolute top-2 right-2 z-10 cursor-pointer px-2 py-1 border border-white/50 rounded-lg bg-black/40 text-[10px] text-white hover:bg-white hover:text-black transition-colors"
        >
          Take Screenshot
        </button>
      )}
